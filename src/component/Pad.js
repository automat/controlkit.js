...
function Pad(parent,object,value,params)
{
    ...
    params            = params            || {};
    params.boundsX    = params.boundsX    || Default.PAD_BOUNDS_X;
    params.boundsY    = params.boundsY    || Default.PAD_BOUNDS_Y;
    params.labelX     = params.labelX     || Default.PAD_LABEL_X;
    params.labelY     = params.labelY     || Default.PAD_LABEL_Y;
    ...
    this._svg.addEventListener(DocumentEventType.MOUSE_DOWN,this._onDragStart.bind(this),false);
...
Pad.prototype._redraw = function(){this._drawValue(this._object[this._key]);};
