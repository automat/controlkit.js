...
NumberInput_Internal = function (stepValue, decimalPlaces, onBegin, onChange, onFinish) {
    ...
    input.addEventListener(NodeEventType.KEY_DOWN, this._onInputKeyDown.bind(this));
...
NumberInput_Internal.prototype._onInputKeyDown = function (e) {
    var step = (e.shiftKey ? Preset.NUMBER_INPUT_SHIFT_MULTIPLIER : 1) * this._valueStep,
        keyCode = e.keyCode;
