...
{
    var rootNode = this._node     = new Node(NodeType.DIV).setStyleClass(CSS.Picker),
        headNode = this._headNode = new Node(NodeType.DIV).setStyleClass(CSS.Head),
        lablWrap = new Node(NodeType.DIV).setStyleClass(CSS.Wrap),
        lablNode = new Node(NodeType.DIV).setStyleClass(CSS.Label),
        menuNode = new Node(NodeType.DIV).setStyleClass(CSS.Menu),
        wrapNode = new Node(NodeType.DIV).setStyleClass(CSS.Wrap);
    ...
    var fieldWrap  = new Node(NodeType.DIV).setStyleClass( CSS.PickerFieldWrap),
        sliderWrap = new Node(NodeType.DIV).setStyleClass(CSS.SliderWrap),
        inputWrap  = new Node(NodeType.DIV).setStyleClass( CSS.PickerInputWrap);
    ...
    var handleField  = this._handleField  = new Node(NodeType.DIV);
        handleField.setStyleClass(CSS.PickerHandleField);

    var handleSlider = this._handleSlider = new Node(NodeType.DIV);
    ...
    var controlsWrap = new Node(NodeType.DIV).setStyleClass(CSS.PickerControlsWrap);

    var buttonPick   = new Node(NodeType.INPUT_BUTTON).setStyleClass(CSS.Button).setProperty('value','pick'),
        buttonCancel = new Node(NodeType.INPUT_BUTTON).setStyleClass(CSS.Button).setProperty('value','cancel');


    var colorContrast = new Node(NodeType.DIV).setStyleClass(CSS.PickerColorContrast);

    var color0 = this._colorCurrNode = new Node(NodeType.DIV),
        color1 = this._colorPrevNode = new Node(NodeType.DIV);
    ...
    var inputFieldWrapHue = new Node(NodeType.DIV).setStyleClass(CSS.PickerInputField),
        inputFieldWrapSat = new Node(NodeType.DIV).setStyleClass(CSS.PickerInputField),
        inputFieldWrapVal = new Node(NodeType.DIV).setStyleClass(CSS.PickerInputField);

    var inputFieldWrapHueLabel = new Node(NodeType.SPAN).setStyleClass(CSS.Label).setProperty('innerHTML','H'),
        inputFieldWrapSatLabel = new Node(NodeType.SPAN).setStyleClass(CSS.Label).setProperty('innerHTML','S'),
        inputFieldWrapValLabel = new Node(NodeType.SPAN).setStyleClass(CSS.Label).setProperty('innerHTML','V');
    ...
    var inputFieldWrapR = new Node(NodeType.DIV).setStyleClass(CSS.PickerInputField),
        inputFieldWrapG = new Node(NodeType.DIV).setStyleClass(CSS.PickerInputField),
        inputFieldWrapB = new Node(NodeType.DIV).setStyleClass(CSS.PickerInputField);

    var inputFieldWrapRLabel = new Node(NodeType.SPAN).setStyleClass(CSS.Label).setProperty('innerHTML','R'),
        inputFieldWrapGLabel = new Node(NodeType.SPAN).setStyleClass(CSS.Label).setProperty('innerHTML','G'),
        inputFieldWrapBLabel = new Node(NodeType.SPAN).setStyleClass(CSS.Label).setProperty('innerHTML','B');
    ...
    var hexInputWrap = new Node(NodeType.DIV);
        hexInputWrap.setStyleClass(CSS.PickerInputWrap);

    var inputHEX = this._inputHEX = new Node(NodeType.INPUT_TEXT),
        inputFieldWrapHEX         = new Node(NodeType.DIV ).setStyleClass(CSS.PickerInputField),
        inputFieldWrapHEXLabel    = new Node(NodeType.SPAN).setStyleClass(CSS.Label);
        ...
        inputHEX.addEventListener(NodeEventType.CHANGE,this._onInputHEXFinish.bind(this));
    ...
    var eventMouseDown = NodeEventType.MOUSE_DOWN,
    ...
    this._valueHue = Default.COLOR_PICKER_VALUE_HUE;
    this._valueSat = Default.COLOR_PICKER_VALUE_SAT;
    this._valueVal = Default.COLOR_PICKER_VALUE_VAL;
    this._valueR   = 0;
    this._valueG   = 0;
    this._valueB   = 0;
...
Picker.setup        = function(parentNode){return Picker._instance = new Picker(parentNode);};
Picker.getInstance = function(){return Picker._instance;};
...
//};
//
//ControlKit.Picker.setup        = function(parentNode){return ControlKit.Picker._instance = new ControlKit.Picker(parentNode);};
