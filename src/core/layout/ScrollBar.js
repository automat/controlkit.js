...
function ScrollBar(parentNode,targetNode,wrapHeight) {
    ...
    var wrap   = this._wrapNode   = new Node(NodeType.DIV),
        node   = this._node       = new Node(NodeType.DIV),
        track  = this._trackNode  = new Node(NodeType.DIV),
        thumb  = this._thumbNode  = new Node(NodeType.DIV);
    ...
    thumb.addEventListener(NodeEventType.MOUSE_DOWN,this._onThumbDragStart.bind(this));
