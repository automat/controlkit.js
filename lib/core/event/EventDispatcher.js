...
EventDispatcher.prototype.addEventListener = function (type, listener, methodName) {
...
EventDispatcher.prototype.removeEventListener = function (type, obj, methodName) {
    if (!this.hasEventListener(type)){
        return;
    }
